...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        # Create 9 authors for pagination tests
        number_of_authors = 9
    ...
    def test_pagination_is_ten(self):
        ...
        # Changed pagination check number from 10 to 6
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # Now change all books (9) to be on loan
        books = BookInstance.objects.all()[:9]
    ...
    def test_pages_ordered_by_due_date(self):
        ...
        # Confirm that of the items, only 6 (not 10) are displayed due to pagination.
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_form_date_of_death_initially_set_to_expected_date(self):
        ...
        expected_initial_date = datetime.date(2000, 1, 1)
